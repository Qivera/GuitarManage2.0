<%@ page
	import="com.DAO.*,com.Model.*,java.sql.*,java.util.*,com.Servlet.*"
		...
		<div class="row-fluid">
			<div class="row">
				<div class="col-md-4">
					...
					%>
					<form class="navbar-form navbar-left" role="search" action="GuitarServlet"
						method="POST">
				...
				<div class="col-md-8">
					<table class="table">
						...
						<%
						if(null != all){ Iterator iter = all.iterator();
							while (iter.hasNext()) {
								...
								String builder =spec.getBuilder().toString();
								String model = spec.getModel();
								String type = spec.getType().toString();
								int numStrings=spec.getNumStrings();
								String backWood = spec.getBackWood().toString();
								String topWood = spec.getTopWood().toString();
								String keyword = request.getParameter("keyword").toUpperCase();
								if (keyword != null) {
									builder = builder.replaceAll(keyword,
											"<font color=\"red\">" + keyword + "</font>");
									model = model.replaceAll(keyword, "<font color=\"red\">"
											+ keyword + "</font>");
